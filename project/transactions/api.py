...
# Via /accounts/<int: account_id>/transactions
def api_create_transaction(account_id):
    ...
    # Format utc_datetime_booked if provided
    utc_datetime_booked = None
    if data.get("utc_datetime_booked") != None:
        try:
            utc_datetime_booked = datetime.fromisoformat(data.get("utc_datetime_booked").replace('Z', '+00:00'))
        except:
